#ifndef PREFETCHER_CMC_REVISION_5_H
#define PREFETCHER_CMC_REVISION_5_H
...
class cmc_revision_5 : public champsim::modules::prefetcher
{
  ...
  public:
    ...
    int index;
    const int degree;
    Recorder() : entries(), index(0), degree(4) {}
  ...
  std::map<champsim::address, IPRecord> training_unit;
