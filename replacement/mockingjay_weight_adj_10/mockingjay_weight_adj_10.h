#ifndef REPLACEMENT_MOCKINGJAY_WEIGHT_ADJ_10_H
#define REPLACEMENT_MOCKINGJAY_WEIGHT_ADJ_10_H
...
class mockingjay_weight_adj_10 : public champsim::modules::replacement {
  CACHE* cache = nullptr;
  ...
  public:
    ...
    void print_profiler(mockingjay_weight_adj_10* parent);
...
public:
  ...
  explicit mockingjay_weight_adj_10(CACHE* cache);
  mockingjay_weight_adj_10(CACHE* cache, long sets, long ways);
