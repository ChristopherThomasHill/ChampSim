#ifndef REPLACEMENT_MOCKINGJAY_WEIGHTED_SPLIT_10_H
#define REPLACEMENT_MOCKINGJAY_WEIGHTED_SPLIT_10_H
...
class mockingjay_weighted_split_10 : public champsim::modules::replacement {
  CACHE* cache = nullptr;
  ...
  public:
    ...
    void print_profiler(mockingjay_weighted_split_10* parent);
...
public:
  ...
  explicit mockingjay_weighted_split_10(CACHE* cache);
  mockingjay_weighted_split_10(CACHE* cache, long sets, long ways);
