#ifndef REPLACEMENT_MOCKINGJAY_WEIGHT_ADJ_4_H
#define REPLACEMENT_MOCKINGJAY_WEIGHT_ADJ_4_H
...
class mockingjay_weight_adj_4 : public champsim::modules::replacement {
  CACHE* cache = nullptr;
  ...
  public:
    ...
    void print_profiler(mockingjay_weight_adj_4* parent);
...
public:
  ...
  explicit mockingjay_weight_adj_4(CACHE* cache);
  mockingjay_weight_adj_4(CACHE* cache, long sets, long ways);
