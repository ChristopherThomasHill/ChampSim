#ifndef REPLACEMENT_MOCKINGJAY_WEIGHTED_SPLIT_14_H
#define REPLACEMENT_MOCKINGJAY_WEIGHTED_SPLIT_14_H
...
class mockingjay_weighted_split_14 : public champsim::modules::replacement {
  CACHE* cache = nullptr;
  ...
  public:
    ...
    void print_profiler(mockingjay_weighted_split_14* parent);
...
public:
  ...
  explicit mockingjay_weighted_split_14(CACHE* cache);
  mockingjay_weighted_split_14(CACHE* cache, long sets, long ways);
