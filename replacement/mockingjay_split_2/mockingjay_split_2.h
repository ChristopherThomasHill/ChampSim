#ifndef REPLACEMENT_MOCKINGJAY_SPLIT_2_H
#define REPLACEMENT_MOCKINGJAY_SPLIT_2_H
...
class mockingjay_split_2 : public champsim::modules::replacement {
  const long NUM_SET;
  const long NUM_WAY;
...
public:
  ...
  explicit mockingjay_split_2(CACHE* cache);
  mockingjay_split_2(CACHE* cache, long sets, long ways);
