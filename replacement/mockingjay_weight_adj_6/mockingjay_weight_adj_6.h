#ifndef REPLACEMENT_MOCKINGJAY_WEIGHT_ADJ_6_H
#define REPLACEMENT_MOCKINGJAY_WEIGHT_ADJ_6_H
...
class mockingjay_weight_adj_6 : public champsim::modules::replacement {
  CACHE* cache = nullptr;
  ...
  public:
    ...
    void print_profiler(mockingjay_weight_adj_6* parent);
...
public:
  ...
  explicit mockingjay_weight_adj_6(CACHE* cache);
  mockingjay_weight_adj_6(CACHE* cache, long sets, long ways);
