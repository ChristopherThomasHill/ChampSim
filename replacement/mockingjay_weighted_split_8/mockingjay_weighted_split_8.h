#ifndef REPLACEMENT_MOCKINGJAY_WEIGHTED_SPLIT_8_H
#define REPLACEMENT_MOCKINGJAY_WEIGHTED_SPLIT_8_H
...
class mockingjay_weighted_split_8 : public champsim::modules::replacement {
  CACHE* cache = nullptr;
  ...
  public:
    ...
    void print_profiler(mockingjay_weighted_split_8* parent);
...
public:
  ...
  explicit mockingjay_weighted_split_8(CACHE* cache);
  mockingjay_weighted_split_8(CACHE* cache, long sets, long ways);
