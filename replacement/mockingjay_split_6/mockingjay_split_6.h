#ifndef REPLACEMENT_MOCKINGJAY_SPLIT_6_H
#define REPLACEMENT_MOCKINGJAY_SPLIT_6_H
...
class mockingjay_split_6 : public champsim::modules::replacement {
  const long NUM_SET;
  const long NUM_WAY;
...
public:
  ...
  explicit mockingjay_split_6(CACHE* cache);
  mockingjay_split_6(CACHE* cache, long sets, long ways);
