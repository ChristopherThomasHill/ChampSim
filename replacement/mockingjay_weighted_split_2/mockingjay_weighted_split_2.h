#ifndef REPLACEMENT_MOCKINGJAY_WEIGHTED_SPLIT_2_H
#define REPLACEMENT_MOCKINGJAY_WEIGHTED_SPLIT_2_H
...
class mockingjay_weighted_split_2 : public champsim::modules::replacement {
  CACHE* cache = nullptr;
  ...
  public:
    ...
    void print_profiler(mockingjay_weighted_split_2* parent);
...
public:
  ...
  explicit mockingjay_weighted_split_2(CACHE* cache);
  mockingjay_weighted_split_2(CACHE* cache, long sets, long ways);
