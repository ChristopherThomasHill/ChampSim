#ifndef REPLACEMENT_MOCKINGJAY_WEIGHT_ADJ_5_H
#define REPLACEMENT_MOCKINGJAY_WEIGHT_ADJ_5_H
...
class mockingjay_weight_adj_5 : public champsim::modules::replacement {
  CACHE* cache = nullptr;
  ...
  public:
    ...
    void print_profiler(mockingjay_weight_adj_5* parent);
...
public:
  ...
  explicit mockingjay_weight_adj_5(CACHE* cache);
  mockingjay_weight_adj_5(CACHE* cache, long sets, long ways);
