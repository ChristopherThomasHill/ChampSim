#ifndef REPLACEMENT_MOCKINGJAY_SPLIT_8_H
#define REPLACEMENT_MOCKINGJAY_SPLIT_8_H
...
class mockingjay_split_8 : public champsim::modules::replacement {
  const long NUM_SET;
  const long NUM_WAY;
...
public:
  ...
  explicit mockingjay_split_8(CACHE* cache);
  mockingjay_split_8(CACHE* cache, long sets, long ways);
