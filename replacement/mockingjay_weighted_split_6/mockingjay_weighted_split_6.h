#ifndef REPLACEMENT_MOCKINGJAY_WEIGHTED_SPLIT_6_H
#define REPLACEMENT_MOCKINGJAY_WEIGHTED_SPLIT_6_H
...
class mockingjay_weighted_split_6 : public champsim::modules::replacement {
  CACHE* cache = nullptr;
  ...
  public:
    ...
    void print_profiler(mockingjay_weighted_split_6* parent);
...
public:
  ...
  explicit mockingjay_weighted_split_6(CACHE* cache);
  mockingjay_weighted_split_6(CACHE* cache, long sets, long ways);
