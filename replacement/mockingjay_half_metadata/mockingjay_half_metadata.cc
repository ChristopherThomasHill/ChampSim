...
int mockingjay_half_metadata::search_sampled_cache(uint64_t blockAddress, uint32_t set)
{
...
void mockingjay_half_metadata::detrain(uint32_t set, int way)
{
...
void mockingjay_half_metadata::update_replacement_state(uint32_t triggering_cpu, long set, long way, champsim::address full_addr, champsim::address ip, champsim::address victim_addr, access_type type, uint8_t hit)
{
