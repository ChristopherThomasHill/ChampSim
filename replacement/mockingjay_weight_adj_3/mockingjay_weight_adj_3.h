#ifndef REPLACEMENT_MOCKINGJAY_WEIGHT_ADJ_3_H
#define REPLACEMENT_MOCKINGJAY_WEIGHT_ADJ_3_H
...
class mockingjay_weight_adj_3 : public champsim::modules::replacement {
  CACHE* cache = nullptr;
  ...
  public:
    ...
    void print_profiler(mockingjay_weight_adj_3* parent);
...
public:
  ...
  explicit mockingjay_weight_adj_3(CACHE* cache);
  mockingjay_weight_adj_3(CACHE* cache, long sets, long ways);
