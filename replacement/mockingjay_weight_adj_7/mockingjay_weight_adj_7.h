#ifndef REPLACEMENT_MOCKINGJAY_WEIGHT_ADJ_7_H
#define REPLACEMENT_MOCKINGJAY_WEIGHT_ADJ_7_H
...
class mockingjay_weight_adj_7 : public champsim::modules::replacement {
  CACHE* cache = nullptr;
  ...
  public:
    ...
    void print_profiler(mockingjay_weight_adj_7* parent);
...
public:
  ...
  explicit mockingjay_weight_adj_7(CACHE* cache);
  mockingjay_weight_adj_7(CACHE* cache, long sets, long ways);
