#ifndef REPLACEMENT_MOCKINGJAY_SPLIT_4_H
#define REPLACEMENT_MOCKINGJAY_SPLIT_4_H
...
class mockingjay_split_4 : public champsim::modules::replacement {
  const long NUM_SET;
  const long NUM_WAY;
...
public:
  ...
  explicit mockingjay_split_4(CACHE* cache);
  mockingjay_split_4(CACHE* cache, long sets, long ways);
