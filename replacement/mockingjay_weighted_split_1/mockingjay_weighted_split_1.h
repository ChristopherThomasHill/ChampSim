#ifndef REPLACEMENT_MOCKINGJAY_WEIGHTED_SPLIT_1_H
#define REPLACEMENT_MOCKINGJAY_WEIGHTED_SPLIT_1_H
...
class mockingjay_weighted_split_1 : public champsim::modules::replacement {
  CACHE* cache = nullptr;
  ...
  public:
    ...
    void print_profiler(mockingjay_weighted_split_1* parent);
...
public:
  ...
  explicit mockingjay_weighted_split_1(CACHE* cache);
  mockingjay_weighted_split_1(CACHE* cache, long sets, long ways);
