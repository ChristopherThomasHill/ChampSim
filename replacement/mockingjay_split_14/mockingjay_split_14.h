#ifndef REPLACEMENT_MOCKINGJAY_SPLIT_14_H
#define REPLACEMENT_MOCKINGJAY_SPLIT_14_H
...
class mockingjay_split_14 : public champsim::modules::replacement {
  const long NUM_SET;
  const long NUM_WAY;
...
public:
  ...
  explicit mockingjay_split_14(CACHE* cache);
  mockingjay_split_14(CACHE* cache, long sets, long ways);
