#ifndef REPLACEMENT_MOCKINGJAY_WEIGHT_ADJ_11_H
#define REPLACEMENT_MOCKINGJAY_WEIGHT_ADJ_11_H
...
class mockingjay_weight_adj_11 : public champsim::modules::replacement {
  CACHE* cache = nullptr;
  ...
  public:
    ...
    void print_profiler(mockingjay_weight_adj_11* parent);
...
public:
  ...
  explicit mockingjay_weight_adj_11(CACHE* cache);
  mockingjay_weight_adj_11(CACHE* cache, long sets, long ways);
