#ifndef REPLACEMENT_MOCKINGJAY_SPLIT_12_H
#define REPLACEMENT_MOCKINGJAY_SPLIT_12_H
...
class mockingjay_split_12 : public champsim::modules::replacement {
  const long NUM_SET;
  const long NUM_WAY;
...
public:
  ...
  explicit mockingjay_split_12(CACHE* cache);
  mockingjay_split_12(CACHE* cache, long sets, long ways);
