#ifndef REPLACEMENT_MOCKINGJAY_SPLIT_1_H
#define REPLACEMENT_MOCKINGJAY_SPLIT_1_H
...
class mockingjay_split_1 : public champsim::modules::replacement {
  const long NUM_SET;
  const long NUM_WAY;
...
public:
  ...
  explicit mockingjay_split_1(CACHE* cache);
  mockingjay_split_1(CACHE* cache, long sets, long ways);
