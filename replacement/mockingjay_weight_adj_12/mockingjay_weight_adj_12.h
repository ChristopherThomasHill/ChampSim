#ifndef REPLACEMENT_MOCKINGJAY_WEIGHT_ADJ_12_H
#define REPLACEMENT_MOCKINGJAY_WEIGHT_ADJ_12_H
...
class mockingjay_weight_adj_12 : public champsim::modules::replacement {
  CACHE* cache = nullptr;
  ...
  public:
    ...
    void print_profiler(mockingjay_weight_adj_12* parent);
...
public:
  ...
  explicit mockingjay_weight_adj_12(CACHE* cache);
  mockingjay_weight_adj_12(CACHE* cache, long sets, long ways);
