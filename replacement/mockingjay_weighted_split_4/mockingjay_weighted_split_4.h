#ifndef REPLACEMENT_MOCKINGJAY_WEIGHTED_SPLIT_4_H
#define REPLACEMENT_MOCKINGJAY_WEIGHTED_SPLIT_4_H
...
class mockingjay_weighted_split_4 : public champsim::modules::replacement {
  CACHE* cache = nullptr;
  ...
  public:
    ...
    void print_profiler(mockingjay_weighted_split_4* parent);
...
public:
  ...
  explicit mockingjay_weighted_split_4(CACHE* cache);
  mockingjay_weighted_split_4(CACHE* cache, long sets, long ways);
