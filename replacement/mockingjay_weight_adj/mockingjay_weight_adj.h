#ifndef REPLACEMENT_MOCKINGJAY_WEIGHT_ADJ_H
#define REPLACEMENT_MOCKINGJAY_WEIGHT_ADJ_H
...
class mockingjay_weight_adj : public champsim::modules::replacement {
  CACHE* cache = nullptr;
  ...
  public:
    ...
    void print_profiler(mockingjay_weight_adj* parent);
...
public:
  ...
  explicit mockingjay_weight_adj(CACHE* cache);
  mockingjay_weight_adj(CACHE* cache, long sets, long ways);
