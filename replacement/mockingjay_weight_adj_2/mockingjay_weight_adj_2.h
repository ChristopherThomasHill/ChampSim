#ifndef REPLACEMENT_MOCKINGJAY_WEIGHT_ADJ_2_H
#define REPLACEMENT_MOCKINGJAY_WEIGHT_ADJ_2_H
...
class mockingjay_weight_adj_2 : public champsim::modules::replacement {
  CACHE* cache = nullptr;
  ...
  public:
    ...
    void print_profiler(mockingjay_weight_adj_2* parent);
...
public:
  ...
  explicit mockingjay_weight_adj_2(CACHE* cache);
  mockingjay_weight_adj_2(CACHE* cache, long sets, long ways);
